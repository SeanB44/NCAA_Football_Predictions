...
cor(mod.dat$difference, mod.dat$win_pct_diff) #0.58
...
cor(mod.dat$difference, mod.dat$SRS_diff)#0.67
mod.dat$SRS_home<-mod.dat$SRS_away<-NULL

## FPI Difference
mod.dat$fpi_diff<-mod.dat$fpi_home-mod.dat$fpi_away
cor(mod.dat$difference, mod.dat$fpi_diff)#0.77
...
cor(mod.dat$difference, mod.dat$sp_plus_diff)#0.72
...
cor(mod.dat$difference, mod.dat$returning_ppa_diff)# 0.35 #Consider
...
cor(mod.dat$difference, mod.dat$Pwr_Rk_diff)#0.61
...
summary(fit.1) #rsq=0.737
# Predict
mod1.preds<-round(predict(fit.1, mod1.test.dat[, -c(1:5)] ), 1)
mod1.test.dat$predicted<-mod1.preds
# Total Absolute Difference
sum(abs(mod1.test.dat$predicted-mod1.test.dat$difference)) #1303
# Mean Absolute Difference
mean(abs(mod1.test.dat$predicted-mod1.test.dat$difference)) #8.52
...
sum(mod1.test.dat$side)/nrow(mod1.test.dat) #81.0
# Cover Spread
...
sum(mod1.test.dat$pred_cover_correct)/nrow(mod1.test.dat) #88.2%
