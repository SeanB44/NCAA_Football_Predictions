...
cor(mod.dat$home_win, mod.dat$returning_ppa_diff)# 0.29
...
confusionMatrix(as.factor(mod1.test.dat$predictions),as.factor(mod1.test.dat$home_win)) #85.6% Accuraccy
prop.table(table(Prediction = mod1.test.dat$predictions, Actual = mod1.test.dat$home_win))%>%round(2)
#Inaccuracies: 10% false positive, 5% false negative
